...
class combined_deep_ROP(object):
    ...
    """
    def __init__(self, input_shape=(3, 224, 224), no_of_classes=2, dir='./GIFGIF_DATA/'):
    ...
    def train(self, save_model_name='./combined.h5', reg_param=0.0002, no_of_score_layers=1, max_no_of_nodes=128, learning_rate=1e-4,
    ...
    def test(self, set, model_file, reg_param=0.0002, no_of_score_layers=1, max_no_of_nodes=128, learning_rate=1e-4,

...
if __name__=="__main__":
    ...
    # Data related
    dataset = '_fac.npy'
    abs_features = np.load('./_features/abs_feat_' + str(args.mode) + dataset)
    abs_labels = np.load('./_features/abs_label_' + str(args.mode) + dataset)
    comp_features = np.load('./_features/comp_feat_' + str(args.mode) + dataset)
    comp_labels = np.load('./_features/comp_label_' + str(args.mode) + dataset)
    #######################################################################################################

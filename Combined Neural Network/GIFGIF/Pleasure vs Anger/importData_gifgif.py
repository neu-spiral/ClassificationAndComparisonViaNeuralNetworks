...
class importData(object):
    def __init__(self, emotion1='pleasure', emotion0='anger', input_shape=(3, 224, 224), dir='./GIFGIF_DATA/'):
    ...
    def load_data(self, set):
        ...
        all_abs_labels = np.load(self.dir + set + '_abs_pleasure.npy')
        all_comp_labels = np.load(self.dir + set + '_comp_pleasure.npy')
        ###################
    ...
    def create_partitions(self, valFold = 3, testFold = 4):
        ...
        # Read all images in Pleasure and Anger folders
        ...
        np.save('train_abs_pleasure', train_abs_labels)
        np.save('val_abs_pleasure', val_abs_labels)
        np.save('test_abs_pleasure', test_abs_labels)
        np.save('train_comp_pleasure', train_comp_labels)
        np.save('val_comp_pleasure', val_comp_labels)
        np.save('test_comp_pleasure', test_comp_labels)